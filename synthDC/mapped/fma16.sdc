...
# Created by write_sdc on Fri Dec  5 20:27:36 2025
...
set_load -pin_load 0.00177087 [get_ports {flags[3]}]
set_load -pin_load 0.00177087 [get_ports {flags[2]}]
set_load -pin_load 0.00177087 [get_ports {flags[1]}]
set_load -pin_load 0.00177087 [get_ports {flags[0]}]
create_clock -name vclk  -period 2.06186  -waveform {0 1.03093}
set_input_delay -clock vclk  -max 0  [get_ports {x[15]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[14]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[13]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[12]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[11]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[10]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[9]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[8]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[7]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[6]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[5]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[4]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[3]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[2]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[1]}]
set_input_delay -clock vclk  -max 0  [get_ports {x[0]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[15]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[14]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[13]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[12]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[11]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[10]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[9]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[8]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[7]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[6]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[5]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[4]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[3]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[2]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[1]}]
set_input_delay -clock vclk  -max 0  [get_ports {y[0]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[15]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[14]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[13]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[12]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[11]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[10]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[9]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[8]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[7]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[6]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[5]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[4]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[3]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[2]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[1]}]
set_input_delay -clock vclk  -max 0  [get_ports {z[0]}]
set_input_delay -clock vclk  -max 0  [get_ports mul]
set_input_delay -clock vclk  -max 0  [get_ports add]
set_input_delay -clock vclk  -max 0  [get_ports negr]
set_input_delay -clock vclk  -max 0  [get_ports negz]
set_input_delay -clock vclk  -max 0  [get_ports {roundmode[1]}]
set_input_delay -clock vclk  -max 0  [get_ports {roundmode[0]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[15]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[14]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[13]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[12]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[11]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[10]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[9]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[8]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[7]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[6]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[5]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[4]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[3]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[2]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[1]}]
set_output_delay -clock vclk  -max 0  [get_ports {result[0]}]
set_output_delay -clock vclk  -max 0  [get_ports {flags[3]}]
set_output_delay -clock vclk  -max 0  [get_ports {flags[2]}]
set_output_delay -clock vclk  -max 0  [get_ports {flags[1]}]
set_output_delay -clock vclk  -max 0  [get_ports {flags[0]}]
